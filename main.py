    """
    Url Shortener Api Irlvc3
    ========================
    Developer-ready web service for transforming requests with built-in validation.
    ...
    APP_NAME    = "Url Shortener Api Irlvc3"
    APP_VERSION = "1.0.0"
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-ready web service for transforming requests with built-in validation.")
